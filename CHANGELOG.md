...
- Added search for saved connections from the home view.
- Added drag-and-drop connection organization by dropping connection cards onto folders or Unsorted.
- Added drag-and-drop folder reordering in the sidebar with persisted order.

### Changed

- Keep empty folders visible in the sidebar so they can be selected, managed, and used as drop targets.

## [1.9.1] - 2026-06-30

### Changed

- Default new connections to the active folder when creating them from a folder-filtered home view.
...
[1.10.0]: https://github.com/thePanda-X/db-viewer/compare/v1.9.1...v1.10.0
[1.9.1]: https://github.com/thePanda-X/db-viewer/compare/v1.9.0...v1.9.1
[1.9.0]: https://github.com/thePanda-X/db-viewer/compare/v1.8.0...v1.9.0
