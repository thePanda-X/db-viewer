...
export type IpcOperation<TNamespace extends IpcNamespace> =
  (typeof IPC_CHANNELS)[TNamespace][number];
export type IpcChannel<TNamespace extends IpcNamespace = IpcNamespace> =
  TNamespace extends IpcNamespace
    ? `${TNamespace}:${IpcOperation<TNamespace>}`
    : never;
